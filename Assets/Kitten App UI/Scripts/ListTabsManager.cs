...
public class ListTabsManager : MonoBehaviour
{
    ...
    // [Header("PANEL ANIMS")]
    private string panelFadeIn = "Profile Panel In";
    private string panelFadeOut = "Profile Panel Out";

    // [Header("BUTTON ANIMS")]
    private string buttonFadeIn = "PP Pressed";
    private string buttonFadeOut = "PP Pressed to Normal";
